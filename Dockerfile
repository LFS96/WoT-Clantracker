...
RUN chmod u+x bin/*
RUN mkdir -p /var/www/html/tmp && chown -R www-data:www-data /var/www/html/tmp/  && chmod 777 -R /var/www/html/tmp/ && \
    mkdir -p /var/www/html/logs && chown -R www-data:www-data /var/www/html/logs/  && chmod 777 -R /var/www/html/logs/
